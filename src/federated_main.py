...
def one_epoch(epoch, global_model, dataset, 
    ...
    gpr = acs['gpr']
    gpr_loss_decrease = acs['gpr_loss_decrease']
    gpr_acc_improve = acs['gpr_acc_improve']
    gpr_data = acs['gpr_data']
    gpr_idxs_users = acs['gpr_idxs_users']
    offpolicy_losses = acs['offpolicy_losses']
    rand_loss_decrease = acs['rand_loss_decrease']
    rand_acc_improve = acs['rand_acc_improve']
    predict_losses = acs['predict_losses']
    init_mu = acs['init_mu']
    sigma = acs['sigma']
    sigma_gt = acs['sigma_gt']
    AFL_Valuation = acs['AFL_Valuation']

    chosen_clients = logging['chosen_clients']
    print_every = logging['print_every']
    writer = logging['writer']
    file_name = logging['file_name']
